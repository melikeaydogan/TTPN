...
vtkDataSet * ReadNcDataFile_Sciviz(float ** Data_out,string FileName,float ** Xcoord, float**Ycoord, float **Zcoord, int x_dim, int y_dim, int z_dim)
{
    ...
    int s_r = 50;
    int ocean_time = 1;
    double Tcline=0.1;  //Not Used anymore in the SciViz
    double * tempVals = new double [s_r*eta_rho*xi_rho];
    int retval;
    double * Cs_r = new double [s_r];
   // double * Cs_w = new double [s_w];  lon_rho
...
//                    cout<<"conditionforThisDataType: "<<conditionforThisDataType<<endl;
			...
			//cout<< "aa = " << aa << endl;
                    ...
                    for(vtkIdType kt1=0; kt1< cursor ; kt1++)
                    {
                        ...
                        double test[3];
                        in_ds->GetPoint(thisCurrentPoint,test);
