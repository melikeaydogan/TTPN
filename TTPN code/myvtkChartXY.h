...
#ifndef __myvtkChartXY_h
#define __myvtkChartXY_h
...
//class VTK_CHARTS_EXPORT myvtkChartXY : public vtkChart
class myvtkChartXY : public vtkChart
{
    //Q_OBJECT

public:
  vtkTypeMacro(myvtkChartXY, vtkChart);
  virtual void PrintSelf(ostream &os, vtkIndent indent);

  // Description:
  // Creates a 2D Chart object.
  static myvtkChartXY *New();
...
private:
  myvtkChartXY(const myvtkChartXY &); // Not implemented.
  void operator=(const myvtkChartXY &);   // Not implemented.
  ...
  void ZoomInAxes(vtkAxis *x, vtkAxis *y, float *origin, float *max);
